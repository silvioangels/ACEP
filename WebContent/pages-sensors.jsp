...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
   <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var chartTemp = new google.visualization.Gauge(document.getElementById('chart_div_temperature'));
        var chartHum  = new google.visualization.Gauge(document.getElementById('chart_div_humidity'));
				...
				<div class="col-md-12">
					...
					<section class="panel">
						...
						<div class="panel-body" align="center">
							...
							<label id="ultimaAtualizacaoTemp">Ultima Atualização: 10:10</label>
							
							<div id="chart_div_humidity"></div>
							<label id="ultimaAtualizacaoHum">Ultima Atualização:  10:12</label>
