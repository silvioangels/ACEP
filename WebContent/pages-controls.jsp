					...
					<form class="form-horizontal form-bordered" action="#"
						...
						<div class="form-group">
							<div class="col-md-12">
								...
								<div class="col-md-6">
									<h4><fmt:message key="relatorios.geracao.compras" /></h4>
								</div>
							</div>
							...
							<div class="col-md-12">
								...
								<div class="col-md-6">
									<h4><fmt:message key="relatorios.geracao.producao" /></h4>
								</div>
							</div>
						...
						<!--<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="col-md-12 form-group">
									<label for=""><h4>Export format</h4></label>
									<select class="form-control">
										<option>Excel</option>
										<option>CSV</option>
										<option>PDF</option>
						...
						<div class="col-md-12">
							<a class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-info"
								href="#"><fmt:message key="relatorios.gerar.alerta" /></a>
						</div>

						<!-- Modal Animation -->
						<!-- <div id="modalAnim" class="zoom-anim-dialog modal-block modal-block-full modal-block-primary mfp-hide">
								<section class="panel">
									...
									<div class="panel-body">
										<div class="modal-wrapper">
											<img src="assets/images/rep02.png" width="100%" height="100%" alt="">
										</div>
									</div>
