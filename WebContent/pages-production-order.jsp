		...
		<div class="inner-wrapper">
			...
			<section role="main" class="content-body">
				<header class="page-header">
					<h2><fmt:message key="producao.cabecalho" /></h2>
					...
					<section class="panel">
						...
						<header class="panel-heading">
							...
							<div class="panel-body" >
								<div class="col-md-4">
									<a href="${pageContext.request.contextPath}/controleproducao?opcao=ordemservico" class="btn btn-info"><fmt:message key="menu.producao.ordem" /></a>
								</div>
								<div class="col-md-4">
									<a href="${pageContext.request.contextPath}/controleproducao?opcao=requisicao" class="btn btn-info"><fmt:message key="menu.producao.requisicao" /></a>
								</div>
							</div>
						</header>
						...
						<div class="panel-body">
							...
							<div class="table-responsive">
								...
								<table class="table">
								    <thead>
								      <tr>
								        <th><fmt:message key="producao.coluna.codigo.ordem" /></th>
								        <th><fmt:message key="producao.coluna.codigo.equipamento" /></th>
								        <th><fmt:message key="producao.coluna.codigo.producao" /></th>
								        <th><fmt:message key="producao.coluna.nome.producao" /></th>
								        <th><fmt:message key="producao.coluna.tempo.medio" /></th>
								        <th><fmt:message key="producao.coluna.perda.cor" /></th>
								        <th><fmt:message key="producao.coluna.quantidade.dano" /></th>
								      </tr>
								    </thead>
								    <tbody>
								    <c:forEach var="itemPedidoProducao" items="${listaPedidoProducao}" varStatus="id">
									      <tr>
									        <td>${itemPedidoProducao.codigo}</td>
									        <td>${itemPedidoProducao.producao.equipamento.codigo}</td>
									        <td>${itemPedidoProducao.producao.codigo}</td>
									        <td>${itemPedidoProducao.producao.nome}</td>
									        <td>${itemPedidoProducao.producao.tempoMedio}</td>
									        <td>${itemPedidoProducao.producao.qtdDesperdicioCor}</td>
									        <td>${itemPedidoProducao.producao.qtdAvaria}</td>
									      </tr>
								      </c:forEach>
								    </tbody>
								  </table>
