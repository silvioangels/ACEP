		...
		<div class="inner-wrapper">
			...
			<section role="main" class="content-body">
				<header class="page-header">
					<h2><fmt:message key="fornecedores.detalhes.ordem" /></h2>
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							<li><span><fmt:message key="passo.fornecedor.detalhe" /></span></li>
						</ol>
					...
					<section class="panel">
						...
						<div class="panel-body">
							...
							<div class="col-md-6 text-center">
								<h4><fmt:message key="fornecedores.ordem.id" /></h4>
								<h3>123</h3>
								<p>
									<fmt:message key="fornecedores.msg.confirmacao.email" /> <b>COMPRAS@T-SYSTEMS.COM.BR</b>
								</p>
							</div>

							<div class="col-md-6 text-center">
								<h4>
									<fmt:message key="fornecedores.ordem.status" />: <b>SENT</b>
								</h4>
								<p>
									<b><fmt:message key="fornecedores.msg.entrega.prazo" /></b>
								</p>
								<h4>
									<b><fmt:message key="fornecedores.pagamento" />:</b>
								</h4>
								<p>
									<b><fmt:message key="fornecedores.valor.total" />:</b> R$ 2,160.00
								</p>

								<h1>
									<span class="fa fa-truck"></span>
								</h1>
								<a class="btn btn-info" href="pages-order-tracking.jsp"><fmt:message key="fornecedores.ordem.rastreamento" /></a>
							</div>
						</div>

						<header class="panel-heading">
							<div class="panel-body">
								<h2><fmt:message key="fornecedores.ordem.status" /></h2>
							</div>
						</header>
						<div class="panel-body">
							<div class="wizard-progress wizard-progress-lg">
								...
								<ul class="wizard-steps">
									<li class="completed"><a href="#w4-account"
										data-toggle="tab" aria-expanded="false"><span>1</span><fmt:message key="fornecedores.encomendado" /></a>
									</li>
									<li class="completed"><a href="#w4-profile"
										data-toggle="tab" aria-expanded="false"><span>2</span><fmt:message key="fornecedores.confirmacao" /></a></li>
									<li class="completed"><a href="#w4-billing"
										data-toggle="tab" aria-expanded="false"><span>3</span><fmt:message key="fornecedores.aceito" /></a></li>
									<li class="active"><a href="#w4-confirm" data-toggle="tab"
										aria-expanded="false"><span>4</span><fmt:message key="fornecedores.enviado" /></a></li>
								</ul>
							</div>
						</div>
					</section>
