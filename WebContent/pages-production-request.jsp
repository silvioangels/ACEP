		...
		<div class="inner-wrapper">
			...
			<section role="main" class="content-body">
				<header class="page-header">
					<h2><fmt:message key="producao.req.cabecalho" /></h2>
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							<li><span><fmt:message key="producao.req.cabecalho" /></span></li>
						</ol>
						...
						<div class="panel-body">
							...
							<div class="table-responsive">
								...
								<table class="table">
								    <thead>
								      <tr>
								        <th><fmt:message key="producao.req.coluna.codigo.ordem" /></th>
										<th><fmt:message key="producao.req.coluna.status.ordem" /></th>
										<th><fmt:message key="producao.req.coluna.delivery.forecast" /></th>
										<th><fmt:message key="producao.req.coluna.prod.quantidade" /></th>
										<th><fmt:message key="producao.req.coluna.valor.total" /></th>
										<th><fmt:message key="producao.req.coluna.nome.cliente" /></th>
								      </tr>
								    </thead>
								    <tbody>
								    <c:forEach var="itemPedidoProducao" items="${listaPedidoProducao}" varStatus="id">
									      <tr>
									        ...
									        <td>${itemPedidoProducao.sp.descricaoTraduzida}</td>
									        <td>${itemPedidoProducao.previsaoEntregaFormatada}</td>
									        <td>${itemPedidoProducao.quantidade}</td>
									        <td>${itemPedidoProducao.valorTotal}</td>
									        <td>${itemPedidoProducao.cliente.nome}</td>
									      </tr>
								      </c:forEach>
								    </tbody>
								  </table>
