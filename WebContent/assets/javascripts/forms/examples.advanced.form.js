...
(function($) {
	...
	*/
	...
	$('#listenSliderCost').change(function() {
		$('.output1 b').text( this.value );
	});

	$('#listenSliderSupply').change(function() {
		$('.output2 b').text( this.value );
	});

	$('#listenSliderDeliv').change(function() {
		$('.output3 b').text( this.value );
	});

	$('#listenSliderSale').change(function() {
