...
<body>
		...
		<div class="inner-wrapper">
			...
			<section role="main" class="content-body">
				<header class="page-header">
					<h2><fmt:message key="passo.producao" /></h2>
					...
					<section class="panel">
						...
						<header class="panel-heading">
							...
							<div class="panel-body">
								<div class="col-md-4">
									<a href="${pageContext.request.contextPath}/pages-robots.jsp?robotimg=Robot1" class="btn btn-info"><fmt:message key="menu.producao.equipamentos.robo.um" /></a>
								</div>
								<div class="col-md-4">
									<a href="${pageContext.request.contextPath}/pages-robots.jsp?robotimg=Robot2" class="btn btn-info"><fmt:message key="menu.producao.equipamentos.robo.dois" /></a>
								</div>
								
								<div class="col-md-4">
									<a href="${pageContext.request.contextPath}/pages-sensors.jsp" class="btn btn-info"><fmt:message key="menu.producao.sensor.temp.umidade" /></a>
								</div>
							</div>
						</header>
						...
						<div class="panel-body" align="center">
							...
							<img id="robotimg" src="assets/images/${param.robotimg}.jpg" width="30%" height="30%" />
							
							<img id="statusimg" src="assets/images/positivegreenhandicon.jpg" width="10%" height="10%" />
	...
	$(function() {
		setInterval(function() {
	    		...
	    		var caminhoSrc = document.getElementById("statusimg").src;
	    		
	    		if(caminhoSrc.indexOf("positivegreenhandicon") > 0){
	    			document.getElementById("statusimg").src = caminhoSrc.replace("positivegreenhandicon","negativeredhandicon");
	    		}else{
	    			document.getElementById("statusimg").src = caminhoSrc.replace("negativeredhandicon","positivegreenhandicon");
	    		}
