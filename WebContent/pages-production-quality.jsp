		...
		<div class="inner-wrapper">
			...
			<section role="main" class="content-body">
				<header class="page-header">
					<h2><fmt:message key="producao.afer.cabecalho" /></h2>
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							<li><span><fmt:message key="producao.afer.cabecalho" /></span></li>
						</ol>
						...
						<div class="panel-body">
							...
							<div class="table-responsive">
								...
								<table class="table">
								    <thead>
								      <tr>
								        <th><fmt:message key="producao.afer.coluna.codigo" /></th>
										<th><fmt:message key="producao.afer.coluna.codigo.produto" /></th>
										<th><fmt:message key="producao.afer.coluna.descricao.produto" /></th>
										<th><fmt:message key="producao.afer.coluna.codigo.verificacao" /></th>
										<th><fmt:message key="producao.afer.coluna.descr.verificacao" /></th>
										<th><fmt:message key="producao.afer.coluna.status" /></th>
										<th><fmt:message key="producao.afer.coluna.nr.nota" /></th>
								      </tr>
								    </thead>
								    <tbody>
								    <c:forEach var="listaQualidadeProdutos" items="${listaQualidadeProdutos}" varStatus="id">
									      <tr>
									        <td>${listaQualidadeProdutos.codigo}</td>
									        <td>${listaQualidadeProdutos.produto.codigo}</td>
									        <td>${listaQualidadeProdutos.produto.descricao}</td>
									        <td>${listaQualidadeProdutos.afericao.codigo}</td>
									        <td>${listaQualidadeProdutos.afericao.descricaoTraduzida}</td>
									        <td>${listaQualidadeProdutos.descricaoStatusTraduzida}</td>
									        <td>${listaQualidadeProdutos.nota}</td>
									      </tr>
								      </c:forEach>
								    </tbody>
								  </table>
